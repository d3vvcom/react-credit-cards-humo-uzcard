...
![demo](https://raw.githubusercontent.com/d3vvcom/react-credit-cards-humo-uzcard/master/docs/media/rccs.gif)
...
```
npm install --save react-credit-cards-humo-uzcard
```
...
import Cards from 'react-credit-cards-humo-uzcard';
...
If you are using SASS, import the CSS `react-credit-cards-humo-uzcard/dist/lib/styles.scss` 

Or you can import the CSS:  
`import 'react-credit-cards-humo-uzcard/dist/es/styles-compiled.css';`
...
1. Clone this repo and link it to your global `node_modules`:
      ...
      $ git clone https://github.com/d3vvcom/react-credit-cards-humo-uzcard.git

      $ cd react-credit-cards-humo-uzcard
